 ...
 */
public class MyTextViewbigr3 extends android.support.v7.widget.AppCompatTextView {

    public MyTextViewbigr3(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public MyTextViewbigr3(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    ...
    public MyTextViewbigr3(Context context)
    {
        super(context);
        init(null);
    }
